/**
 * This is going to implement the link list. For CS5004/5 lab5.
 *
 * @author  Yong Shi
 * @version 1.0
 * @since   2021-06-16
...
public class TListImpl implements TList {
    ...
    public boolean add(String val) {
        ...
        /**
         * @return when we reach here, traversePtr is pointing to the last node of the linked list.
         */
    ...
    /**
     * @throws throw new IndexOutOfBoundsException().
     * @param index
     * @return
     */
    @Override
    public String get(int index) {
        ...
        /**
         * @param we get out of the loop if:
